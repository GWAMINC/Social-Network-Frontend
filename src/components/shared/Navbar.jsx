...
const Navbar = () => {
    return (
        <div className="bg-[#BFB26F] fixed top-0 left-0 w-full z-10 shadow-md">
            <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-6">
                ...
                <div className="flex items-center gap-6">
                    <Link to="/messages" className="relative text-white hover:text-gray-200 transition-colors flex items-center gap-2 p-2 rounded-md">
                    ...
                    <Link to="/notifications" className="relative text-white hover:text-gray-200 transition-colors flex items-center gap-2 p-2 rounded-md">
                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    <div className="flex flex-col text-gray-600">
                                        <div className="flex items-center gap-2 cursor-pointer">
                                            <User2 />
                                            <Button variant="link" className="text-[#B48FD9] hover:text-[#BFB26F]">View Profile</Button>
                                        </div>
                                        <div className="flex items-center gap-2 cursor-pointer">
                                            <LogOut />
                                            <Button variant="link" className="text-[#B48FD9] hover:text-[#BFB26F]">Logout</Button>
                                        </div>
                                    </div>
                                </div>
                            </PopoverContent>
